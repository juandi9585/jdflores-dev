...
typography:
  ...
  headline:
    fontFamily: "Console Display, Michroma, system-ui, sans-serif"
    fontSize: "clamp(2.07rem, 1.7rem + 1.84 * min(1vw, 1.6vh), 3.75rem)"
    fontWeight: 400
    lineHeight: 1
    letterSpacing: "-0.01em"
  title:
    fontFamily: "Console Display, Michroma, system-ui, sans-serif"
    fontSize: "clamp(1.44rem, 1.29rem + 0.74 * min(1vw, 1.6vh), 2rem)"
    fontWeight: 400
    lineHeight: 1.08
    letterSpacing: "-0.01em"
  body:
  ...
  body-lead:
    fontFamily: "Saira, system-ui, sans-serif"
    fontSize: "clamp(1.2rem, 1.11rem + 0.44 * min(1vw, 1.6vh), 1.5rem)"
    fontWeight: 400
    lineHeight: 1.5
  label:
    fontFamily: "Saira, system-ui, sans-serif"
